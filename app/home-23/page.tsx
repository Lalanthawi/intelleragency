...
export const metadata = {
  title: 'Insurance Agency - Inteller Agency',
}
  ...
  return (
    <LayoutTwo>
      ...
      <AboutV15
        ...
        subTitle="For over [X] years, Inteller Agency has been a leading insurance consultancy firm, helping businesses and individuals navigate the complexities of insurance. Our expertise spans risk management, claims assistance, regulatory compliance, and customized insurance planning."
